...
train_data = TCGADataset_image("/gpfs/home/chenz05/DL2023/input/metadata/train_dataset.csv",train_transform)
valid_data = TCGADataset_image("/gpfs/home/chenz05/DL2023/input/metadata/valid_dataset.csv",validation_transform)
...
model.fc = torch.nn.Linear(in_features=512, out_features=n_class, bias=True)
model = model.cuda()
