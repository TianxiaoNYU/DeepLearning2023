...
plt.savefig("/gpfs/home/chenz05/DL2023/output/2_baseMulti/TZ/TZ_multiomics_performance_{b}_{l}_0427.png".format(b = batch_size, l = learning_rate ))
plt.clf()

torch.save(model_trained, "/gpfs/home/chenz05/DL2023/output/2_baseMulti/TZ/TZ_multiomics_whole_model_{b}_{l}_0427.pt".format(b = batch_size, l = learning_rate ))
